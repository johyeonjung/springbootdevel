...
import me.johyeonjung.springbootdeveloper.config.oauth.OAuth2AuthorizationRequestBasedOnCookieRepository;
import me.johyeonjung.springbootdeveloper.config.oauth.OAuth2SuccessHandler;
import me.johyeonjung.springbootdeveloper.config.oauth.OAuth2UserCustomService;
    ...
    public WebSecurityCustomizer configure() {
        return (web) -> web.ignoring()
            .requestMatchers(toH2Console())
             .requestMatchers("/img/**","/css/**", "/static/img/js/**");
